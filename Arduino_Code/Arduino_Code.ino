...
void returnData()
{
    String outgoingData = "<" + String(status) + "," \
                          + uBatt + "," + iBatt + ">";
    ...
    else if (commandFromESP == 1)
    {
        if (controlTarget <= 0 - deltaPMin)
        {
            if (bsFull == false)
            {
                ...
                if (controlTarget < bsPowerCharging)
                {
                    controlTarget = bsPowerCharging;
                }
                status = 1;
                charge();
            }
        ...
        else if (controlTarget >= 0 + deltaPMin)
        {
            if (bsEmpty == false)
            {
                ...
                if (controlTarget > bsPowerDischarging)
                {
                    controlTarget = bsPowerDischarging;
                }
                status = 2;
                discharge();
            }
...
void debugPC()
{
    Serial.println("uNT: " + String(uNT) + ", uBatt: " \
                   + String(uBatt) + ", uWR>: " + String(uWR) \ 
                   + ", iBatt: " + String(iBatt) \
                   + ", controlTarget: " + String(controlTarget));
}
///////////////////////////////////////////////////
